...
const THREEPIPE_SUPPORTED_TYPES = ['model/gltf-binary', 'model/gltf+json', 'application/fbx'];
...
export default class ThreePipe extends AssetActionPlugin {
  get show() {
    ...
    return (
      this.component.isBrowserProtocol &&
      (THREEPIPE_SUPPORTED_TYPES.includes(this.asset.type) || THREEPIPE_SUPPORTED_FILEEXTS.some(ext => suffix === ext))
    );
  }
