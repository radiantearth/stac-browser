...
const F3D_SUPPORTED_TYPES = ['model/gltf-binary', 'model/gltf+json', 'application/fbx'];
...
export default class F3D extends AssetActionPlugin {
  get show() {
    ...
    return (
      ...
      (F3D_SUPPORTED_TYPES.includes(this.asset.type) || F3D_SUPPORTED_FILEEXTS.some(ext => suffix === ext))
    );
  }
