...
export default {
  ...
  computed: {
    ...mapState(['data', 'url', 'apiItems', 'apiItemsLink', 'apiItemsPagination', 'itemsPerPage']),
    ...
    itemPages() {
      ...
      if (!pages.first && this.data && this.apiItemsLink && this.apiItemsLink.rel !== 'items') {
        pages.first = Utils.addFiltersToLink(this.data.getApiItemsLink(), this.filters, this.itemsPerPage);
      }
      return pages;
    },
    isApi() {
