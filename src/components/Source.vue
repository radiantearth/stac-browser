<template>
  <div class="share mt-1">
    <b-button-group>
      <b-button v-if="showRoot" tabindex="0" size="sm" variant="outline-primary" id="popover-root-btn">
        <b-icon-box /> <span class="button-label">{{ rootTitle }}</span>
      </b-button>
      <b-button v-if="stacUrl" tabindex="0" size="sm" variant="outline-primary" id="popover-link-btn" :title="$t('source.detailsAboutSource')">
        <b-icon-link /> <span class="button-label">{{ $t('source.label') }}</span>
      </b-button>
      <b-button tabindex="0" size="sm" variant="outline-primary" id="popover-share-btn" :title="$t('source.share.withOthers')">
