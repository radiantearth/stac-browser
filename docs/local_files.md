...
If you are using a hosted version of STAC Browser, such as the [STAC Browser Demo](https://stac-browser.moregeo.it) by moreGeo, and your STAC files use relative URIs, you can run a local webserver. One possibility is to use the Node package described above. Another is to use this Python 3 script:
